...
class CSIActuator(BaseActuator):
    ...
    def __init__(self, monitor, kubeconfig: Optional[str] = None) -> None:
        super().__init__(monitor)
    ...
    def _get_client(self):
        if self._k8s_client is None:
            try:
                ...
                logger.warning("Failed to initialize k8s client: %s. Falling back to stub.", e)
    ...
    def execute_move(self, volume_id: str, source_node: str, target_node: str, size_gb: float, op_id: str) -> bool:
        ...
        # Simulated Kubernetes CSI driver patching nodeAffinity
        if hasattr(self.monitor, "update_phase"):
